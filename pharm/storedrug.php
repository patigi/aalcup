...
mysql_select_db($database_pharmConn, $pharmConn);
$query_check_transaction = "SELECT stock.stockdid FROM stock";
$check_transaction = mysql_query($query_check_transaction, $pharmConn) or die(mysql_error());
$row_check_transaction = mysql_fetch_assoc($check_transaction);
$totalRows_check_transaction = mysql_num_rows($check_transaction);
...
?>
							...
							<div class="col-lg-4 form-group">
                              <input type="text" class="form-control" name="expiry" placeholder="yyyy-mm-dd">
